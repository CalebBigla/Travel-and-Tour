...
import { Menu, X, Plane, Map } from "lucide-react";
      ...
      {open && (
        <nav className="border-t border-border bg-background lg:hidden" aria-label="Mobile">
          <div className="container-page flex flex-col gap-1 py-4">
            ...
            <Link to="/tours" onClick={close} className="flex items-center gap-2 rounded-md px-3 py-2.5 text-sm font-semibold hover:bg-secondary">
              <Map className="h-4 w-4 text-accent" /> Tour Services
            </Link>
