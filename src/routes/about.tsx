...
import { Plane, Map, ShieldCheck, Award, FileCheck, Handshake, Target, Users } from "lucide-react";
...
const title = `About ${site.name} | ${site.rcNumber}, ${site.cityRegion}`;
const description =
  `${site.name} is a registered Nigerian company (${site.rcNumber}) in ${site.cityRegion} operating a travel services division and a tour services division.`;
...
const team = [
  ...
  { name: "Team member name", role: "Head, Tour Services", initials: "TS" },
];

/* PLACEHOLDER MILESTONES — replace with real dates and events before launch. */
const milestones = [
  {
    year: "20XX",
    title: "Company founded",
    description: `${site.name} established in ${site.cityRegion} to serve the travel and tour needs of the region.`,
  },
  {
    year: "20XX",
  ...
  {
    year: "20XX",
    title: "Tour division expansion",
    description: "Expanded service offering into tour packages, group tours, and bespoke travel experiences to complement our core travel services.",
  },
  {
    year: "20XX",
    title: "Office establishment",
    description: `Opened permanent office at ${site.addressLine}, providing a physical location for clients across the region.`,
  },
];
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[1.6fr_1fr]">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              {site.name} was founded in {site.cityRegion} to solve a problem that kept showing up at the same door: people needed help navigating visa applications and international travel, and they also wanted curated tour experiences that went beyond basic bookings. Rather than refer clients elsewhere, we built both capabilities under one roof.
            </p>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              The two divisions aren't a random pairing — they share the same operational discipline. The same attention to documentation that gets a visa approved also ensures a tour itinerary is meticulously planned. The same logistics coordination that arranges multi-city flights also manages group tour departures. Clients who need visas often book tours; tour clients need visa support. Having both services in-house means one accountable relationship, not two vendors to manage.
            </p>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Today, the company operates from {site.addressLine}, serving individual travelers, families, groups, and corporate clients across the region. We're registered ({site.rcNumber}), reachable on three phone lines and WhatsApp, and we show up when you need us.
            </p>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Some companies split travel services and tours into separate businesses. We keep them together deliberately, because the skills overlap more than they seem to at first glance:
            </p>
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                <span><strong className="text-foreground">Documentation discipline:</strong> Visa applications and tour bookings both require precise paperwork, tracked timelines, and clear communication with third parties (embassies, hotels, airlines).</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                <span><strong className="text-foreground">Logistics coordination:</strong> Arranging a group tour with flights, hotels, and transfers uses the same project management skills as coordinating multi-destination itineraries with tight connections.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                <span><strong className="text-foreground">Vendor verification:</strong> We vet hotels, airlines, and tour operators through the same rigorous process — checking references, confirming terms in writing, and building a trusted network over time.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                <span><strong className="text-foreground">Client overlap:</strong> Individual travelers who need visas often book full tour packages. Tour clients need visa processing support. Managing both needs through one relationship is simpler than coordinating two vendors.</span>
              </li>
            </ul>
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2">
              <div className="rounded-xl border border-border bg-card p-6 shadow-card">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Visa processing, flight bookings, hotel reservations and travel consultancy for
              ...
              <div className="rounded-xl border border-border bg-card p-6 shadow-card">
                ...
                <h3 className="mt-3 text-lg font-bold text-primary">Tour Services</h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  Tour packages, group tours, custom itineraries, family packages and tour
                  consultancy for memorable experiences.
                </p>
                <Link to="/tours" className="mt-4 inline-block text-sm font-bold text-accent-foreground underline underline-offset-4">
      ...
      <section className="border-y border-border bg-secondary/60 py-16">
        <div className="container-page">
          ...
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Key milestones in building {site.name} — placeholder dates, replace with real timeline before launch
          </p>
