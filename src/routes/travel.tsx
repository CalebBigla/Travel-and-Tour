...
const title = `Travel Services — Visa Processing & Flight Bookings in ${site.cityRegion} | ${site.name}`;
const description =
  `Visa processing ${site.cityRegion}, flight bookings, hotel reservations, and travel consultancy from ${site.name}.`;
...
const visaDestinations = [
  {
    ...
    types: "Visitor, Business, Study, Work",
    timeline: "3 weeks average",
    notes: "Biometrics required at VFS Global (Abuja or Lagos). Strong financial proof essential.",
  },
  {
    country: "Schengen (Europe)",
    types: "Tourist, Business, Visit",
    timeline: "15 working days",
    notes: "Apply at embassy of main destination. Travel insurance mandatory (€30k coverage).",
  },
  {
    country: "United States",
    types: "B1/B2 Visitor, Student F1, Work H1B",
    timeline: "Variable (2-8 weeks)",
    notes: "Interview at US Embassy Abuja required. Appointment waits vary by season.",
  },
  {
    country: "Canada",
    types: "Visitor, Study, Work",
    timeline: "4-6 weeks",
    notes: "Online application. Biometrics at VAC Abuja or Lagos. Police certificate sometimes required.",
  },
  {
    country: "UAE (Dubai)",
    types: "Tourist, Visit",
  ...
  {
    country: "Saudi Arabia (Hajj/Umrah)",
    types: "Pilgrimage",
    timeline: "Variable by season",
    notes: "Vaccination certificate mandatory. Apply through licensed agents (we coordinate).",
  },
];
          ...
          >
            <div className="container-page">
              ...
              {service.slug === "hotel-reservations" && (
                <div className="mt-10">
                  <h3 className="text-xl font-bold text-primary">Featured hotel partners</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Examples of accommodations we book across destinations — from budget-friendly comfort to premium stays
                  </p>
                  <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {[
                      { img: hotel1Img, title: "Comfort Stays", desc: "Cozy accommodations for budget-conscious travelers" },
                      { img: hotel2Img, title: "Business Suites", desc: "Professional environments for corporate travelers" },
                      { img: hotel3Img, title: "Premium Rooms", desc: "Luxury options for discerning guests" },
                      { img: hotel4Img, title: "Beachfront Escapes", desc: "Seaside getaways and resort destinations" },
                    ].map((hotel, idx) => (
                      <div
                        key={idx}
      ...
      <section id="inquiry-form" className="scroll-mt-20 bg-primary-deep py-16">
        <div className="container-page max-w-3xl">
          <InquiryForm
            ...
            intro={`Hello ${site.name}! I have a travel enquiry.`}
            fields={[
