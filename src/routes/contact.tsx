...
const title = `Contact ${site.name} | ${site.cityRegion}`;
const description =
  `Call, WhatsApp, email or visit our office at ${site.addressLine} for travel or tour enquiries.`;
  ...
  return (
    <>
      <PageHero
        ...
        subtitle={`Call, message on WhatsApp, email, or walk into the office in ${site.cityRegion}. Travel or tours — we will point you to the right desk.`}
      />
      ...
      <section className="py-16">
        <div className="container-page grid gap-10 lg:grid-cols-[1fr_1.2fr]">
          ...
          <InquiryForm
            ...
            intro={`Hello ${site.name}! I would like to make an enquiry.`}
            fields={[
